...
```
For this data, we are comparing the two element model and the five element model. The P-value is 0.9 and the R-sum of squares for the five element model is slightly below than the two element model. In conclusion, there is barely a difference between the models with the two element model being better.
